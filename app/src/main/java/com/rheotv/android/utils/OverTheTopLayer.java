...
public class OverTheTopLayer {
    ...
    /**
     * Draws the story as per the drawable resource id on the given location pixels.
     */
    ...
    /**
     * Holds the scaling factor for the story.
     *
     * @param scale
     * @return
     */
    ...
    public FrameLayout create() {
        ...
        if (activity != null) {
            ...
            FrameLayout.LayoutParams topLayerParam = new FrameLayout.LayoutParams(CommonUtils.toPix(100), FrameLayout.LayoutParams.MATCH_PARENT, Gravity.TOP);
    ...
    /**
     * Applies the animation to the story view present in OTT.
     *
     * @param animation
     */
