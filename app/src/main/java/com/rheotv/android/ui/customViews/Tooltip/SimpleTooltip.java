package com.rheotv.android.ui.customViews.Tooltip;
...
public class SimpleTooltip implements PopupWindow.OnDismissListener {
    ...
    private SimpleTooltip(Builder builder) {
        ...
        mAutoHideDuration = builder.autoHideDuration;
    ...
    private void setUpCloseHandler() {
        if (mAutoHide)
            new Handler().postDelayed(this::dismiss, mAutoHideDuration);
    }
    ...
    public static class Builder {
        ...
        public SimpleTooltip build() throws IllegalArgumentException {
            ...
            if (contentView == null) {
                ...
                tv.setBackground(SimpleTooltipUtils.getBackground(backgroundColor));
        ...
        public Builder autoHideDuration(int autoHideDuration) {
