...
@Module
class DonationEditFragmentModule {
    @Provides
    fun viewModel(dataManager: DataManager, schedulerProvider: SchedulerProvider) =
            UserProfileViewModel(dataManager, schedulerProvider)

    @Provides
    fun provideViewModel(viewModel: UserProfileViewModel): ViewModelProvider.Factory =
