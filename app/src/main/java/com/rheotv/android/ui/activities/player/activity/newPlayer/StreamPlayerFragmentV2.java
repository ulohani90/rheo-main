...
public class StreamPlayerFragmentV2 extends BaseFragment<FragmentStreamPlayerV2Binding, StreamPlayerViewModelV2>
    ...
    private StreamPlayerViewModelV2 mViewModel;
    ...
    public static StreamPlayerFragmentV2 getInstance(PostObject postObject, String sourceScreen) {
        StreamPlayerFragmentV2 fragment = new StreamPlayerFragmentV2();
    ...
    public StreamPlayerViewModelV2 getViewModel() {
        if (mViewModel == null) {
            mViewModel = new ViewModelProvider(this, mViewModelFactory)
                    .get(StreamChatFragmentV2.DEFAULT_KEY + streamFragmentPosition, StreamPlayerViewModelV2.class);
...
//            SpannableString spannableString = new SpannableString(getString(R.string.welcome_user_message, CommonUtils.getUserName()));
    ...
    private void setOnViewClickListeners() {
        ...
        mBinding.messageContainer.setOnClickListener(new BackPressUpdateClickListener() {
            ...
            public void onViewClick(@org.jetbrains.annotations.Nullable View v) {
                if (CommonUtils.isUserLoggedin())
                    ChatBoxBottomSheetDialog.Companion.newInstance(StreamPlayerFragmentV2.this, mViewModel.authorUsername()).
            ...
            bottomScratchCardView.setAction(new BackPressUpdateClickListener() {
                ...
                public void onViewClick(@Nullable View v) {
                    try {
                        ...
                        scratchDialogFragment.show(StreamPlayerFragmentV2.this.getChildFragmentManager(), AppConstants.SCRATCH_FRAGMENT_TAG, StreamPlayerFragmentV2.this, suggestReward);
