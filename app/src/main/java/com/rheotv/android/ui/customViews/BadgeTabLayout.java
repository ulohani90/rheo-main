...
public class BadgeTabLayout extends TabLayout {
    ...
    private void makeCustomIcon(Tab tab, View view) {
        ...
        DrawableCompat.setTintList(tab.getIcon(), getTabIconTint());
     ...
     * @param recourse drawable resourse of vector icon
     */
    public void setIcon(int position, @DrawableRes int recourse) {
    ...
    public void setTextColor(int index, @ColorRes int color) {
        TabLayout.Tab tab = getTabAt(index);
        if (tab == null || tab.getCustomView() == null) {
            Log.e(TAG, "Tab is null. Not setting custom view");
            return;
        ...
        TextView tabText = tab.getCustomView().findViewById(R.id.textview_tab_title);
        tabText.setTextColor(getResources().getColor(color));
        TransitionManager.beginDelayedTransition((ViewGroup) tab.getCustomView());
    }

    public void setTabIndicator(int index, @DrawableRes int drawable) {
        TabLayout.Tab tab = getTabAt(index);
        if (tab == null || tab.getCustomView() == null) {
            Log.e(TAG, "Tab is null. Not setting custom view");
            return;
        ...
        ImageView tabIndicator = tab.getCustomView().findViewById(R.id.indicator_tab_icon);
        tabIndicator.setImageResource(drawable);
