...
import com.rheotv.android.ui.activities.customroom.di.CustomRoomBottomSheetModule;
...
@Module
public class OnBoardingContainerFragmentModule {
    ...
    ViewModel provideViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        return new OnBoardingViewModel(dataManager, schedulerProvider);
    }
}
