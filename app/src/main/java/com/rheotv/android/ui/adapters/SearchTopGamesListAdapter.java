...
public class SearchTopGamesListAdapter extends RecyclerView.Adapter<BaseViewHolder> {


    List<SearchItem> mTopGames;

    TopGamesGridAdapter.OnTopGamesCardClick mListener;

    public SearchTopGamesListAdapter(List<SearchItem> topGames) {
        this.mTopGames = topGames;
    }

    public void setListener(TopGamesGridAdapter.OnTopGamesCardClick mListener) {
    ...
    public class ItemTopGameCardViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            BindingUtils.setImageUrlUsingCache(mBinding.gameImage, result.getUrl(), true);
