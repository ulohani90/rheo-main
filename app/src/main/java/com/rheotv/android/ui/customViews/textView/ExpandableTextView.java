package com.rheotv.android.ui.customViews.textView;
...
public class ExpandableTextView extends AppCompatTextView {
    ...
    public ExpandableTextView(final Context context, @Nullable final AttributeSet attrs, final int defStyle) {
        ...
        this.animationDuration = attributes.getInt(R.styleable.ExpandableTextView_animation_duration, context.getResources().getInteger(R.integer.default_animation_duration));
        attributes.recycle();
