...
@Module
public class AudioChatRoomFragmentModule {
    ...
    @Provides
    @IntoMap
    @ViewModelKey(AudioChatRoomActivityViewModel.class)
    ViewModel provideViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
        return new AudioChatRoomActivityViewModel(dataManager, schedulerProvider);
    }
