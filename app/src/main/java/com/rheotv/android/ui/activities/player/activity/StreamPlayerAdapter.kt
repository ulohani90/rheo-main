...
import com.rheotv.android.ui.activities.player.activity.StreamPlayerContainerFragment.TAG
import com.rheotv.android.ui.activities.player.activity.streamplayer.utils.RestrictedMap

class StreamPlayerAdapter internal constructor(fm: FragmentManager, lifecycle: Lifecycle,
    ...
    private var currentFragment: StreamPlayerFragment? = null

    override fun getItem(position: Int): StreamPlayerFragment? {
    ...
    override fun createFragment(position: Int): StreamPlayerFragment {
//        return if (mMap.containsKey(position)) {
//            mMap[position]!!
//        } else {
        currentFragment = StreamPlayerFragment.getInstance(mList[position], sourceScreen)
//            mMap.putRestricted(
//                    position,
//                    StreamPlayerFragment.getInstance(mList[position], sourceScreen)
//            )
        Log.i(TAG, "StreamPlayer_called: createFragmentCalled")
        return currentFragment!!
//        }
    }
